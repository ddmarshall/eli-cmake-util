  ...
  elseif((warning_level_ MATCHES "^[1-9]$") AND (warning_level_ GREATER 0))
    ...
    if (COMPILER_SUPPORT_C_WALL)
      ...
      if (warning_level_ GREATER 2)
        ...
        if (${FLAG_STRING} STREQUAL "NOT_FOUND")
          message(WARNING "Could not determine flag for C I/O format string "
                          "overflow warning")
        else()
          set(FINAL_STRING "${FINAL_STRING} ${FLAG_STRING}")
        endif()
        ...
        if (${FLAG_STRING} STREQUAL "NOT_FOUND")
          message(WARNING "Could not determine flag for C logical operations "
                          "parenthesis warning")
        else()
          set(FINAL_STRING "${FINAL_STRING} ${FLAG_STRING}")
        endif()
        ...
        if (${FLAG_STRING} STREQUAL "NOT_FOUND")
          message(WARNING "Could not determine flag for C I/O implicit float "
                          "promotion to double warning")
        else()
          set(FINAL_STRING "${FINAL_STRING} ${FLAG_STRING}")
        endif()
        ...
        if (${FLAG_STRING} STREQUAL "NOT_FOUND")
          message(WARNING "Could not determine flag for C write strings "
                          "warning")
        else()
          set(FINAL_STRING "${FINAL_STRING} ${FLAG_STRING}")
        endif()
